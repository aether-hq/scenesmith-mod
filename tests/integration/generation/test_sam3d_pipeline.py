...
try:
    from scenesmith.agent_utils.geometry_generation_server.pipelines.cuda_env_setup import (
        ensure_cuda_env,
    )
...
from scenesmith.agent_utils.geometry_generation_server.pipelines.sam3d_pipeline_manager import (
...
class TestSAM3DPipelineIntegration(unittest.TestCase):
    ...
    def test_sam3d_real_image_with_rendering(self):
        ...
        # Use real test image.
        image_path = Path(__file__).parents[2] / "test_data" / "office_shelf.png"
