...
class TestOpenAIImageGenerator(unittest.TestCase):
    ...
    @patch(
        "scenesmith.agent_utils.assets.image_generation._extract_and_save_openai_image"
    )
...
class TestGeometryGeneration(unittest.TestCase):
    ...
    @patch(
        "scenesmith.agent_utils.geometry_generation_server.pipelines.hunyuan3d_pipeline_manager.Hunyuan3DPipelineManager"
    )
