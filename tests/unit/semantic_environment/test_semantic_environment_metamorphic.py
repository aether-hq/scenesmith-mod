...
from scenesmith.agent_utils.structure.compiler.models import audit_triangle_mesh
...
class TestGeneratedSemanticGeometry(unittest.TestCase):
    ...
    def test_compilation_is_deterministic_across_hash_seeds(self) -> None:
        ...
        script = textwrap.dedent(
            """
            import hashlib
            from tests.unit.semantic_environment.test_semantic_environment_metamorphic import _star_environment
            from scenesmith.agent_utils.semantics.environment.semantic_environment_compiler import (
                SemanticCompileOptions,
                compile_semantic_environment,
            )
