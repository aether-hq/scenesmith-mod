...
class TestRenderingManager(unittest.TestCase):
    ...
    @patch(
        "scenesmith.agent_utils.rendering.rendering_manager.render_scene_for_agent_observation"
    )
    ...
    @patch("scenesmith.agent_utils.rendering.rendering_manager.time.sleep")
    @patch(
        "scenesmith.agent_utils.rendering.rendering_manager.render_scene_for_agent_observation"
    )
