...
from scenesmith.agent_utils.runtime.execution_providers import ProviderUnavailableError
...
class TestGeometryExecutionProviders(unittest.TestCase):
    ...
    @patch(
        "scenesmith.agent_utils.geometry_generation_server.pipelines.sam_provider.platform.machine",
        return_value="x86_64",
    )
    @patch(
        "scenesmith.agent_utils.geometry_generation_server.pipelines.sam_provider.platform.system",
        return_value="Linux",
    )
