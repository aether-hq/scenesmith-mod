...
from scenesmith.agent_utils.blender.server.conversion_endpoints import (
    BlenderConversionEndpointsMixin,
)
...
class BlenderRenderApp(BlenderConversionEndpointsMixin, flask.Flask):
