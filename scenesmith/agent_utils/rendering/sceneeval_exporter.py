...
from scenesmith.agent_utils.rendering.sceneeval_house_export import (
    SceneEvalHouseExportMixin,
)
...
if TYPE_CHECKING:
    ...
    from scenesmith.agent_utils.scene.house_parts.openings import Opening
...
class SceneEvalExporter(SceneEvalHouseExportMixin):
